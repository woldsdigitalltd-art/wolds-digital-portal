import { AlertTriangle, CalendarClock, CheckCircle2, SearchCheck, XCircle } from 'lucide-react'
import {
  categoryBreakdown,
  scoreColour,
  type SeoAuditResult,
...
export interface SeoViewSchedule extends ScheduleInput {
...
function SectionHeader({ schedule }: { schedule?: SeoViewSchedule | null }) {
  return (
    <div className="mb-6">
