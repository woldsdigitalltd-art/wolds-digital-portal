import { CalendarClock, CheckCircle2, ExternalLink, Unlink } from 'lucide-react'
...
export interface BrokenLinksViewSchedule extends ScheduleInput {
...
export function BrokenLinksView({
  ...
  schedule?: BrokenLinksViewSchedule | null
}) {
  return (
    <div>
...
function SectionHeader({ schedule }: { schedule?: BrokenLinksViewSchedule | null }) {
  return (
    <div className="mb-6">
